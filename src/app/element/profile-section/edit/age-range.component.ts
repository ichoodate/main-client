...
export class ProfileSectionEditAgeRangeComponent extends ProfileSectionEditComponent {
  ...
  public minChange() {
    ...
    HttpService.api().get<AgeRange[]>('keyword/max-age-ranges', {
      params: {
        min: min
      }
  ...
  public static setUp$(data: Data) {
    ...
    const minList$ = HttpService.api().get<AgeRange[]>('keyword/min-age-ranges', {
      params: {
        max: '50'
      }
    }).pipe(
    ...
    if ( data.ageRange ) {
      ...
      return forkJoin(minList$, HttpService.api().get<AgeRange[]>('keyword/max-age-ranges', {
        params: {
  ...
  public submit$() {
    ...
    return HttpService.api().post<AgeRange>(this.profileType+'-keyword/age-ranges', {
