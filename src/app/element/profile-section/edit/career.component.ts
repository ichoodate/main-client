...
export class ProfileSectionEditCareerComponent extends ProfileSectionEditComponent {
  ...
  public ngOnInit() {
    ...
    this.careersCtrl.at(0).setValidators([
  ...
  public change(i: number) {
    ...
    HttpService.api().get<Career[]>('keyword/careers', {
      params: {
  ...
  public static setUp$(data: Data) {
    ...
    const parentIds = data.careers.map((career: Career) => career.getAttrs().id)
  ...
  public submit$() {
    ...
    return HttpService.api().post<Career>(this.profileType+'-keyword/careers', {
