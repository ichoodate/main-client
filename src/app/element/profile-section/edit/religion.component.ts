...
export class ProfileSectionEditReligionComponent extends ProfileSectionEditComponent {
  ...
  public static setUp$(data: Data) {
    ...
    return HttpService.api().get<Religion[]>('keyword/religions', {
    }).pipe(
  ...
  public submit$() {
    ...
    return HttpService.api().post<Religion>(this.profileType+'-keyword/religions', {
