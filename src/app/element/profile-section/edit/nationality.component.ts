...
export class ProfileSectionEditNationalityComponent extends ProfileSectionEditComponent {
  ...
  public static setUp$(data: Data) {
    ...
    return HttpService.api().get<Country[]>('keyword/countries', {
      params: {
        expands: 'nationality'
      }
    }).pipe(
  ...
  public submit$() {
    ...
    return HttpService.api().post<Nationality>(this.profileType+'-keyword/nationalities', {
