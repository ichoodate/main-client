...
export class ProfileSectionEditStatureComponent extends ProfileSectionEditComponent {
  ...
  public submit$() {
    ...
    return HttpService.api().post<Stature>(this.profileType+'-keyword/stature', {
